...
def run_test(sequence, base_dir, feature_conf, matcher_conf, run_name, run_localization=False):
    ...
    mfile = match_features.main(matcher_conf, ref_pairs, fconf['output'], run_dir)
    ...
    if run_localization:
        ...
        for sequence in ['training', 'validation', 'test0', 'test1'][2:]:
            ...
            mfile = match_features.main(matcher_conf, loc_pairs, fconf['output'], run_dir)
